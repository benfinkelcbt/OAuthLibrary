...
class MainPage(BaseHandler):
    def get(self):
        ...
        self.response.write('<h3><a href="/signin?provider=github">Sign in with GitHub</a></h3>')
        self.response.write('<h3><a href="/signin?provider=oic_google">Sign in with Google (OIC)</a></h3>')
        self.response.write('<h3><a href="/signin?provider=oic_yahoo">Sign in with Yahoo (OIC)</a></h3>')
